...
drun -d --name rnnfp16_container -w $WORK_DIR rocm/pytorch-private:rocm4.0.1_ubuntu18.04_py3.6_pytorch-rocblas-tuned-rnnfp16-miopen
# docker cp . rnnfp16_container:/root/pytorch
docker attach rnnfp16_container
