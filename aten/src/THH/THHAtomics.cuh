...
#if ((HIP_VERSION < 10000) || (defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 700)))
...
#if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 600 || HIP_VERSION < 8000)
...
#elif !defined(__CUDA_ARCH__) && (HIP_VERSION < 8000) || defined(__HIP_PLATFORM_HCC__)
