...
#include <THH/THHTensorTypeUtils.cuh>
#include <THH/THHTensorCopy.hpp>
...
#define HANDLE_CASE(TYPE, A)                                              \
  kernelPointwiseApply1<Op, ScalarTypeA, TYPE, A>                         \
    <<<grid, block, 0, c10::hip::getCurrentHIPStreamMasqueradingAsCUDA(curDevice)>>>(     \
    ...
    */
    if (aInfo.dims == 1) {
      ...
      kernelPointwiseApply1<Op,
                            ScalarTypeA,
                            uint64_t, 1>
        <<<grid, block, 0, c10::hip::getCurrentHIPStreamMasqueradingAsCUDA()>>>(
